...
const ProjectItems: IProjectItem[] = [
    ...
    },
    {
        ...
        description: [
            ...
            <>
                Won <b>Best Hack at Berkeley</b> from FreeVentures and <b>Best use of AWS</b> from Amazon at{" "}
                <a href="http://www.calhacks.io/" />
                Cal Hacks 2.0
            </>,
        ],
    },
...
class Project extends React.PureComponent<{ data: IProjectItem }> {
            ...
            <GridColumn>
                <Segment className="basic clearing">
                    ...
                    <Header className="left floated large">
                        ...
                        <Header.Subheader>Language: {this.props.data.languages}</Header.Subheader>
                    </Header>
                </Segment>
