...
/***/ function(module, exports, __webpack_require__) {
	...
	var Body, React, ReactDOM, ga, logPageView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var About, Body, Contact, Experience, Extracurricular, Footer, Item, Links, Menu, Navigation, Projects, React, Sections, ref;

	React = __webpack_require__(1);

	Navigation = __webpack_require__(169);

	Footer = __webpack_require__(435);

	About = __webpack_require__(436);

	Experience = __webpack_require__(438);

	Projects = __webpack_require__(439);

	Extracurricular = __webpack_require__(440);

	Links = __webpack_require__(441);

	Contact = __webpack_require__(442);

	ref = __webpack_require__(454), Item = ref.Item, Menu = ref.Menu;
	...
	Body = React.createClass({
	  ...
	  render: function() {
	    ...
	    return React.createElement("div", null, React.createElement(Menu, {
	      "className": "vertical inverted thin sidebar"
	    }, (function() {
	      var j, len, results;
	      results = [];
	      ...
	      return results;
	    })()), React.createElement(Navigation, null), React.createElement(About, null), React.createElement(Experience, null), React.createElement(Projects, null), React.createElement(Extracurricular, null), React.createElement(Links, null), React.createElement(Contact, null), React.createElement(Footer, null));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Container, Icon, Item, Menu, Navigation, React, Sections, Segment, ref;

	React = __webpack_require__(1);

	ref = __webpack_require__(454), Segment = ref.Segment, Container = ref.Container, Icon = ref.Icon, Menu = ref.Menu, Item = ref.Item;
	...
	Navigation = React.createClass({
	  ...
	  render: function() {
	    ...
	    return React.createElement(Segment, {
	      "className": "vertical basic center aligned"
	    ...
	    }, React.createElement(Item, null, React.createElement("a", {
	      "className": "ui button blue",
	      "href": "resume_tex/resume.pdf"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Column, Container, Footer, Grid, Icon, React, Segment, ref;

	React = __webpack_require__(1);

	ref = __webpack_require__(454), Segment = ref.Segment, Container = ref.Container, Grid = ref.Grid, Column = ref.Column, Icon = ref.Icon;

	Footer = React.createClass({
	  displayName: 'Footer',
	  render: function() {
	    return React.createElement(Segment, {
	      "className": "inverted vertical footer"
	    }, React.createElement(Container, null, React.createElement(Grid, {
	      "className": "stackable inverted divided"
	    }, React.createElement(Column, {
	      "className": "thirteen wide"
	    }, "Copyright © 2016 by Myles Scolnick"), React.createElement(Column, {
	      "className": "three wide"
	    }, React.createElement("a", {
	      "className": "ui button blue",
	      "href": "resume_tex/resume.pdf"
	    }, React.createElement(Icon, {
	      "className": "file pdf outline"
	    }), " Print")))));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var About, Column, Container, ContentSection, Divider, Grid, Image, React, ref;

	React = __webpack_require__(1);

	ContentSection = __webpack_require__(437);

	ref = __webpack_require__(454), Grid = ref.Grid, Divider = ref.Divider, Image = ref.Image, Container = ref.Container, Column = ref.Column;
	...
	About = React.createClass({
	  ...
	  render: function() {
	    return React.createElement(ContentSection, {
	      ...
	      "className": "stackable two column middle aligned vertically padded"
	    }, React.createElement(Column, {
	      "className": "four wide"
	    ...
	    }, React.createElement("p", null, "Hello, world! My name is Myles Scolnick. I graduated from the University of California, Berkeley, with degrees in Computer Science and Mathematics. I am currently a software engineer working around the world."), React.createElement("p", null, "I have a remarkable aptitude for problem-solving and embrace any challenge presented to me. I aspire to work on difficult problems that have tangible impacts on the world. I am most interested in leveraging software to solve difficult problems with big data that is otherwise impossible."), React.createElement("p", null, "Please feel free to contact me personally; my information is listed ", React.createElement("a", {
	      "href": "#contact"
	    }, "below"), ".")))));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Container, ContentHeader, ContentSection, React, Segment, ref;

	React = __webpack_require__(1);

	ContentHeader = __webpack_require__(453);

	ref = __webpack_require__(454), Segment = ref.Segment, Container = ref.Container;
	...
	ContentSection = React.createClass({
	  ...
	  render: function() {
	    return React.createElement(Segment, {
	      "className": "basic vertical stripe",
	      "id": this.props.id
	    }, React.createElement(Container, null, React.createElement(ContentHeader, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Column, Container, ContentSection, Divider, Experience, ExperienceItem, ExperienceItems, Grid, Header, Image, Progress, ProgressType, React, ReactDOM, Row, Segment, TechincalItem, TechincalItems, ref;
	...
	ref = __webpack_require__(454), Grid = ref.Grid, Divider = ref.Divider, Image = ref.Image, Container = ref.Container, Column = ref.Column, Progress = ref.Progress, Segment = ref.Segment, Header = ref.Header, Row = ref.Row;
	...
	ExperienceItems = [
	  {
	    ...
	    time: 'Summer 2015',
	    description: ['Worked on adding new improvements and features to Palantir\'s <a href="https://www.palantir.com/solutions/trader-oversight/">trader oversight solution</a>', 'Developed a new understanding of Postgres Full Text Search, large-scale web applications, build automation tools, and dependency management']
	  }, {
	    ...
	    time: 'Spring 2015',
	    description: ['Conducted research on students to develop insights about student technology usage and trends', 'Acquired great insight into the tech world and furthered developed my research capabilities with real business implications']
	  }, {
	    url: 'https://www.palantir.com',
	    logoName: 'palantir.png',
	    name: 'Palantir Technologies',
	    ...
	    time: 'Summer 2014',
	    description: ['Developed new management tools to deploy a subset of Palantir software with increased reliability and efficiency', 'Gained large project experience, increased Java/Shell skills, as well as team collaboration and other proficiencies', 'Created tests plans and implemented back end (BE) automation tests to ensure project stability from code changes']
	  }, {
	    ...
	    description: ['Infused Red Bull into the student lifestyle through co-ordination of projects on university campus and support of student events', 'Developed and maintain relationships and support of key university bodies and individuals', 'Seeked opportunities to develop Red Bull’s brand profile, image and credibility on and around campus within the student market']
	  }, {
	    ...
	    time: 'Summer 2011',
	    description: ['Worked with a team to find a cure for Type 1 Diabetes in mice by examining the roles of auto-reactive T-cells in diabetes', 'Studied APC\'s, CD4\'s, and V-alpha chains (1-19) to developed a correlation between age of mice and beta-islet configuration', 'Analyzed gel electrophoresis samples to separate protein solution to determine V-alpha chains present in mice pancreas']
	  }
	];
	...
	Experience = React.createClass({
	  ...
	  render: function() {
	    ...
	    return React.createElement(ContentSection, {
	      ...
	      var j, len, results;
	      results = [];
	      for (i = j = 0, len = ExperienceItems.length; j < len; i = ++j) {
	        item = ExperienceItems[i];
	        results.push(React.createElement(ExperienceItem, {
	          "data": item,
	          "key": i
	        }));
	      }
	      ...
	      "className": "piled"
	    }, React.createElement(Header, null, "Technical"), (function() {
	      var j, len, results;
	      results = [];
	      for (i = j = 0, len = TechincalItems.length; j < len; i = ++j) {
	        item = TechincalItems[i];
	        results.push(React.createElement(TechincalItem, {
	          "data": item,
	          "progressType": ProgressType[i % ProgressType.length],
	          "key": i
	        }));
	      }
	      return results;
	    })(), React.createElement("em", null, "Tools: "), "Git, Vim, Eclipse, AWS, Processing, Bootstrap, Hadoop, Xcode, Twilio, CMake, OpenCV, OpenMP, SSE Intrinsics, SQLite, LaTeX, jQuery, VirtualBox", React.createElement("br", null), React.createElement("em", null, "OS: "), "Mac OS, Linux\x2FUbuntu"))));
	  }
	});
	...
	ExperienceItem = React.createClass({
	  ...
	  render: function() {
	    ...
	    }, this.props.data.position))), React.createElement("ul", {
	      "className": "blue"
	    }, (function() {
	      var j, len, ref1, results;
	      ref1 = this.props.data.description;
	      results = [];
	...
	TechincalItem = React.createClass({
	  ...
	  render: function() {
	    return React.createElement(Grid, null, React.createElement(Column, {
	      "className": "three wide"
	    }, this.props.data.name), React.createElement(Column, {
	      "className": "thirteen wide"
	    }, React.createElement(Progress, {
	      "className": "" + this.props.progressType,
	      "init": {
	        percent: this.props.data.progress
	      }
	    }, React.createElement("div", {
	      "className": "bar"
	    }))));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Column, ContentSection, Grid, Header, Icon, Project, ProjectItems, Projects, React, Segment, ref;

	React = __webpack_require__(1);

	ContentSection = __webpack_require__(437);

	ref = __webpack_require__(454), Header = ref.Header, Icon = ref.Icon, Segment = ref.Segment, Grid = ref.Grid, Column = ref.Column;
	...
	ProjectItems = [
	  {
	    ...
	    time: 'Fall 2015',
	    description: ['Built a natural language model to algorithmically determine the best North American Industry Classification System (NAICS) code for a given small business', 'Received second in the Radius Collider Competition (through UC Berkeley\'s SCET)', 'Incorporated several techniques including text cleaning, data augmentation, TF-IDF, wordnet, neural embeddings and cross-validation to improve accuracy']
	  }, {
	    url: 'https://datalessapp.github.io/',
	    name: 'Dataless',
	    languages: 'Python, Flask, Twilio, Android/Java, AWS EC2',
	    time: 'Fall 2015',
	    description: ['Built an application on Android to get remote information and internet access without using data and only using SMS', 'Created a protocol with SMS to simulate network packets capable of handling dropped packets and out of order packets', 'Won <b>Best Hack at Berkeley</b> from FreeVentures and <b>Best use of AWS</b> from Amazon at <a href="http://www.calhacks.io/">Cal Hacks 2.0']
	  }, {
	    url: 'https://github.com/mscolnick/StockAnalysis',
	    name: 'Stock Analysis',
	    languages: 'Python, Flask, SQLite, Jinja, HTML/CSS/JS',
	    time: 'Spring 2015',
	    description: ['Created a web application (Front/Back End) to provide technical analysis and graphs for searched stocks', 'Implemented variety of trading indicators such as MFRAMA, RSI, ADX, MACD for technical analysis on quotes', 'Added external APIs to give more context for a given stock such as current quote, tweets, and interactive graphs']
	  }, {
	    url: 'https://github.com/mscolnick/ADX_Cryptocurrency',
	    name: 'ADX Cryptocurrency Trader',
	    languages: 'Python',
	    time: 'Spring 2014',
	    description: ['Built a program to analyze trends in crypto-currency, specifically Dogecoin and Bitcoin, with the ADX technical indicator', 'Automatically tracked momentum of currency fluctuations to determine prime opportunity to buy and sell currency', 'Implemented APIs of currency exchanges and digital wallets to configure auto-trading at high velocities']
	  }, {
	    url: 'https://github.com/mscolnick/DrSearch',
	    name: 'Dr. Search',
	    languages: 'Java/Processing',
	    time: 'Spring 2013',
	    description: ['Developed a fully functional cell counter to detect and count the number of cells in a given image or selection of images', 'Created the ability to run through a folder of images and export an Excel spreadsheet with results of 43 images in 2 seconds', 'Implemented ‘blob-detection’ and ‘edge-detected’ to locate cells, color cells, and count cells with little to no error']
	  }
	];
	...
	Projects = React.createClass({
	  ...
	  render: function() {
	    ...
	    return React.createElement(ContentSection, {
	      ...
	      "className": "one column vertically padded"
	    }, (function() {
	      var j, len, results;
	      results = [];
	      for (i = j = 0, len = ProjectItems.length; j < len; i = ++j) {
	        p = ProjectItems[i];
	...
	Project = React.createClass({
	  ...
	  render: function() {
	    var d, i;
	    return React.createElement(Column, null, React.createElement(Segment, {
	      "className": "basic clearing"
	    }, React.createElement(Header, {
	      "className": "right floated small"
	    }, this.props.data.time), React.createElement(Header, {
	      ...
	      "href": this.props.data.url
	    }, this.props.data.name, " ", React.createElement(Icon, {
	      "className": "linkify tiny"
	    })), React.createElement("div", {
	      "className": "sub header"
	    }, "Language: ", this.props.data.languages))), React.createElement("ul", {
	      "className": "blue"
	    }, (function() {
	      var j, len, ref1, results;
	      ref1 = this.props.data.description;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Column, ContentSection, ExItems, Extracurricular, ExtracurricularItem, Grid, Header, React, Segment, ref;

	React = __webpack_require__(1);

	ContentSection = __webpack_require__(437);

	ref = __webpack_require__(454), Header = ref.Header, Column = ref.Column, Grid = ref.Grid, Segment = ref.Segment;
	...
	Extracurricular = React.createClass({
	  ...
	  render: function() {
	    ...
	    return React.createElement(ContentSection, {
	      ...
	      var j, len, results;
	      results = [];
	      for (i = j = 0, len = ExItems.length; j < len; i = ++j) {
	        item = ExItems[i];
	        results.push(React.createElement(ExtracurricularItem, {
	          "data": item,
	          "key": i
	        }));
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	ref = __webpack_require__(454), Header = ref.Header, List = ref.List, Item = ref.Item, Icon = ref.Icon;
	...
	Links = React.createClass({
	  ...
	  render: function() {
	    return React.createElement(ContentSection, {
	      ...
	      "title": "Links",
	      "icon": "linkify"
	    }, React.createElement(List, null, React.createElement(Item, null, React.createElement(Header, {
	      "className": "large"
	    }, "Media"), React.createElement(List, null, React.createElement(Item, {
	      "type": "link",
	      "href": "http://denver.cbslocal.com/2012/08/15/teenage-diabetic-works-to-find-cure/"
	    }, React.createElement(Icon, {
	      "className": "right arrow"
	    }), "Teenage Diabetic Works To Find Cure For Disease"), React.createElement(Item, {
	      "type": "link",
	      "href": "http://www.bloomberg.com/news/articles/2016-03-22/credit-suisse-cia-funded-palantir-build-joint-compliance-firm"
	    }, React.createElement(Icon, {
	      "className": "right arrow"
	    }), "Credit Suisse, CIA-Funded Palantir to Target Rogue Bankers"))), React.createElement(Item, null, React.createElement(Header, {
	      "className": "large"
	    }, "Works"), React.createElement(List, null, React.createElement(Item, {
	      "type": "link",
	      "href": "https://www.ocf.berkeley.edu/~scolnick/StockAnalysis/"
	    }, React.createElement(Icon, {
	      "className": "right arrow"
	    }), "Stock Analysis"), React.createElement(Item, {
	      "type": "link",
	      "href": "https://datalessapp.github.io/"
	    }, React.createElement(Icon, {
	      "className": "right arrow"
	    }), "Dataless")))));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Column, Contact, ContentSection, Divider, Grid, Header, React, SocialItems, ref;

	React = __webpack_require__(1);

	ContentSection = __webpack_require__(437);

	ref = __webpack_require__(454), Grid = ref.Grid, Header = ref.Header, Column = ref.Column, Divider = ref.Divider;

	SocialItems = [
	  {
	    name: 'email',
	    link: 'mailto:mscolnick@gmail.com'
	  }, {
	    name: 'linkedin',
	    link: 'https://www.linkedin.com/in/mscolnick'
	  }, {
	    name: 'github',
	    link: 'https://github.com/mscolnick'
	  }, {
	    name: 'quora',
	    link: 'http://www.quora.com/Myles-Scolnick'
	  }, {
	    name: 'twitter',
	    link: 'https://twitter.com/TheMylesFiles'
	  }, {
	    name: 'skype',
	    link: 'skype:MylesScolnick?call'
	  }
	];
	...
	Contact = React.createClass({
	  ...
	  render: function() {
	    ...
	    return React.createElement(ContentSection, {
	      ...
	      "className": "two column middle aligned stackable vertically padded"
	    }, React.createElement(Column, null, React.createElement("ul", {
	      "className": "blue"
	    }, React.createElement("li", null, "(303)–250–0788"), React.createElement("li", null, "Email: ", React.createElement("a", {
	      "href": "mailto:mscolnick@gmail.com"
	    }, "mscolnick@gmail.com")))), React.createElement(Column, null, (function() {
	      var j, len, results;
	      results = [];
	      for (i = j = 0, len = SocialItems.length; j < len; i = ++j) {
	        s = SocialItems[i];
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Utilities
	 */
	var format = __webpack_require__(444);
	var removeLeadingSlash = __webpack_require__(449);
	var trim = __webpack_require__(447);

	var warn = __webpack_require__(448);
	var log = __webpack_require__(450);
	...
	var OutboundLink = __webpack_require__(451);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mightBeEmail = __webpack_require__(445);
	var toTitleCase = __webpack_require__(446);
	var warn = __webpack_require__(448);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Content, ContentHeader, Divider, Icon, React, Segment, ref;

	React = __webpack_require__(1);

	ref = __webpack_require__(454), Segment = ref.Segment, Divider = ref.Divider, Icon = ref.Icon, Content = ref.Content;
	...
	ContentHeader = React.createClass({
	  ...
	  render: function() {
	    return React.createElement(Divider, {
	      "className": "horizontal huge header"
	    }, React.createElement(Icon, {
	      "className": "" + this.props.icon
	    }), React.createElement(Content, null, this.props.title));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _form = __webpack_require__(463);
	...
	var _fields = __webpack_require__(471);
	...
	var _text = __webpack_require__(475);
	...
	var _flag = __webpack_require__(480);
	...
	var _icon = __webpack_require__(482);

	var _icon2 = _interopRequireDefault(_icon);

	var _image = __webpack_require__(483);
	...
	var _label = __webpack_require__(485);
	...
	var _loader = __webpack_require__(487);

	var _loader2 = _interopRequireDefault(_loader);

	var _rail = __webpack_require__(488);

	var _rail2 = _interopRequireDefault(_rail);

	var _reveal = __webpack_require__(489);

	var _reveal2 = _interopRequireDefault(_reveal);

	var _segment = __webpack_require__(490);
	...
	var _steps = __webpack_require__(492);

	var _steps2 = _interopRequireDefault(_steps);

	var _accordion = __webpack_require__(493);
	...
	var _dimmer = __webpack_require__(495);
	...
	var _embed = __webpack_require__(497);

	var _embed2 = _interopRequireDefault(_embed);

	var _modal = __webpack_require__(498);
	...
	var _progress = __webpack_require__(500);
	...
	var _shape = __webpack_require__(503);
	...
	var _sticky = __webpack_require__(505);
	...
	var _advertisement = __webpack_require__(507);
	...
	var _comment = __webpack_require__(509);

	var _comment2 = _interopRequireDefault(_comment);

	var _comments = __webpack_require__(510);

	var _comments2 = _interopRequireDefault(_comments);

	var _feed = __webpack_require__(511);
	...
	var _items = __webpack_require__(513);

	var _items2 = _interopRequireDefault(_items);

	var _statistic = __webpack_require__(514);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _div = __webpack_require__(462);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _unit = __webpack_require__(474);
